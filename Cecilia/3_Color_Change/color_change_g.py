...
n_saturation = 0.3 #this value reduces R B so that G shines brighter

def f_set_pixel_value(a_pixel, n_value):
    a_pixel[0] = n_value * n_saturation # b
    a_pixel[1] = n_value # g
    a_pixel[2] = n_value * n_saturation # r
...
b = cv2.imwrite("color_change_g.jpg", o_img)
print(b)